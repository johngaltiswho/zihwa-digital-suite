    ...
    <>
      ...
      <div className="bg-blue-800 text-white py-2 px-6 md:px-12 text-sm">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
          {/* Left: Contact Info */}
          <div className="flex flex-wrap justify-center md:justify-start items-center space-x-4 md:space-x-6 w-full md:w-auto">
      ...
      <header className="py-4 px-6 md:px-12 flex flex-col md:flex-row justify-between items-center bg-white shadow-md gap-4 md:gap-0">
        <Link href="/">
        ...
        <nav className="w-full md:w-auto">
          <ul className="flex justify-center md:justify-end space-x-6 flex-wrap">
