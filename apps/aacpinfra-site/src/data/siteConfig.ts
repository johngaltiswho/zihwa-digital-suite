// apps/aacpinfra-site/src/data/siteConfig.ts

export const siteConfig = {
    siteName: "AACP Infrastructure Systems Pvt. Ltd.", // Updated from summary
    tagline: "Building Tomorrow's Infrastructure, Today.", // Keep existing tagline
    ...
    contactInfo: {
      address: "Bangalore, Karnataka, India", // Updated from summary (generalized)
      phone: "+919403890723", // Updated from summary
      email: "info@aacpinfra.com", // Updated from summary
