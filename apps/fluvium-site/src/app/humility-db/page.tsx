      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/20 backdrop-blur-sm border-b border-gray-800/30">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <span className="text-cyan-400 font-light">Humility DB</span>
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-sm border border-gray-700/30 rounded-2xl p-8">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-3xl font-light text-white">Welcome Back, Warrior</h2>
            ...
            {recentTechniques.map((technique) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font-light ${getDifficultyColor(technique.metadata.difficulty_level)}`}>
                ...
                <div className="flex items-center justify-between text-gray-400 text-sm">
                  ...
                  <span>{formatDuration(technique.metadata.duration_minutes)}</span>
                </div>
            ...
            {flowSessions.map((session) => (
              <div key={session.id} className="bg-gray-800/50 rounded-lg p-6 hover:bg-gray-700/50 transition-colors duration-300 cursor-pointer">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-cyan-400 text-sm">{formatDuration(session.metadata.duration_minutes)}</span>
                </div>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-xs text-gray-400">
                        <span>{formatDuration(module.metadata.duration_minutes)}</span>
                        <span>•</span>
