...
export default async function fixV2Pricing({ container }: ExecArgs) {
  console.log("💰 Fixing Medusa v2 pricing...")
  ...
  try {
    ...
    for (const product of products) {
      try {
        ...
        console.log(`🔧 Processing: ${product.title} - Base price: ₹${price}`)
