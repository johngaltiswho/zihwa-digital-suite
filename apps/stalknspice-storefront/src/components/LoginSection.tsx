    ...
    <section className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-3">
      <div className="w-full max-w-[500px] bg-white rounded-[50px] shadow-xl shadow-gray-200/50 p-10 md:p-10 border border-gray-100">
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input 
                ...
                className="w-full bg-gray-50 rounded-full px-6 py-3 font-bold text-gray-800 outline-none focus:ring-2 focus:ring-[#8B2323]/10 border-none transition-all" 
              />
          ...
          <button 
            type="submit"
            className="w-full bg-[#8B2323] text-white font-bold uppercase tracking-widest py-4 rounded-full flex items-center justify-center gap-2 hover:bg-black transition-all shadow-xl shadow-[#8B2323]/20 active:scale-[0.98]"
          >
